...
import static per.taller.todotic.app.security.Constantes.AUTH_HEADER_NAME;
import static per.taller.todotic.app.security.Constantes.TOKEN_PREFIX;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	protected void successfulAuthentication(HttpServletRequest req, HttpServletResponse res, FilterChain chain,
		...
		res.addHeader(AUTH_HEADER_NAME, TOKEN_PREFIX + token);
	...
	private void writeSessionData(HttpServletResponse response, AppUserDetails userDetails, String token,
